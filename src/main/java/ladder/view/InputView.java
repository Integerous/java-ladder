...
public class InputView {
    ...
    private static final String MESSAGE_FOR_INPUT_RESULTS = "실행 결과를 입력하세요. (결과는 쉼표(,)로 구분하세요)";
    public static final String MESSAGE_FOR_INPUT_WANTED_RESULT = "결과를 보고 싶은 사람은?";
    ...
    public static String askResults() {
        printEmptyLine();
        System.out.println(MESSAGE_FOR_INPUT_RESULTS);
        return scanner.nextLine();
    }
    ...
    public static String askWhichResultToSee() {
        printEmptyLine();
        System.out.println(MESSAGE_FOR_INPUT_WANTED_RESULT);
        return scanner.nextLine();
    }
